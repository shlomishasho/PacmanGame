...
from ai_finalProject.Search.search_methods import is_free_space
from ai_finalProject.point import RoomStatus, PointStatus
    ...
    def _set_room_addon(self, maze, name, color):
        while True:
            ...
            if new_addon.width > 1 and new_addon.height > 1:
                ...
                colors = RoomStatus.get_addons_colors () + [PointStatus.WALL]
                if is_free_space (x_center, y_center, maze.maze_matrix, colors, new_addon.get_dimensions ()):
